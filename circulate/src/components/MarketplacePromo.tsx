    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <a 
                    href= "https://circulatesignup.auth.us-east-1.amazoncognito.com/login?client_id=7s7o7e3tm5e8220l8f3947n8rj&response_type=code&scope=email+openid+phone&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fcallback" 
                    style={{
